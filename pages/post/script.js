...
const containerListPosts = document.querySelector("#posts_container col-12 col-md-9 col-lg-6");
...
const renderPost = (dataPost) => {
  ...
  const anchorAuthorName = document.createElement("h4")
  anchorAuthorName.className = "font-weight-bold p-2"
  anchorAuthorName.textContent = dataPost.author.name

  const anchorAuthorDate = document.createElement("p")
  anchorAuthorDate.className = "p-2"
 ...
 btnEliminar.addEventListener("click", (event) => {
  ...
  containerListPosts.appendChild(card);
};
...
const parserResponsePostFireBase = (object) => {
  ...
  for (const key in object) {
    ...
    listPostParsed.push(objectParsed);
  }
